...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--prefix=/home/owt-server/dist/audio_agent/ffmpeg_libfdkaac_src --enable-shared --disable-static --disable-libvpx --disable-vaapi --enable-libfdk-aac --enable-nonfree --enable-libfreetype
prefix=/home/owt-server/dist/audio_agent/ffmpeg_libfdkaac_src
...
CFLAGS=-fPIC   -std=c11 -fomit-frame-pointer -fPIC -pthread  -I/home/owt-server/dist/audio_agent/ffmpeg_libfdkaac_src/include -I/usr/include/freetype2 -I/usr/include/libpng16    -g -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Wno-unused-const-variable -Wno-bool-operation -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=format-security -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla -Wformat -fdiagnostics-color=auto -Wno-maybe-uninitialized
...
avutil_FFLIBS=
EXTRALIBS-avdevice=-lm -lxcb -lxcb-shape -lxcb-xfixes
EXTRALIBS-avfilter=-pthread -lm -lfreetype
EXTRALIBS-swscale=-lm
EXTRALIBS-postproc=-lm
EXTRALIBS-avformat=-lm -lz
EXTRALIBS-avcodec=-pthread -lm -lz -L/home/owt-server/dist/audio_agent/ffmpeg_libfdkaac_src/lib -lfdk-aac
