...
extralibs_avcodec="-pthread -lm -lz -L/home/owt-server/dist/audio_agent/ffmpeg_libfdkaac_src/lib -lfdk-aac"
extralibs_avformat="-lm -lz"
extralibs_avdevice="-lm -lxcb -lxcb-shape -lxcb-xfixes"
extralibs_avfilter="-pthread -lm -lfreetype"
