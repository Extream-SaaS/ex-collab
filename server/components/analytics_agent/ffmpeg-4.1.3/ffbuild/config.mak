...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--prefix=/home/owt/analytics_agent/ffmpeg-install --enable-shared --disable-static --disable-libvpx --disable-vaapi --enable-libfreetype
prefix=/home/owt/analytics_agent/ffmpeg-install
...
CFLAGS=-fPIC   -std=c11 -fomit-frame-pointer -fPIC -pthread  -I/usr/include/freetype2 -I/usr/include/libpng16 -g -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Wno-unused-const-variable -Wno-bool-operation -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=format-security -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla -Wformat -fdiagnostics-color=auto -Wno-maybe-uninitialized
